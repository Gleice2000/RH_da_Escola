...
public class Tecnico extends Funcionario implements Salario{
    private int siape;
    private String departamento;
    
    public Tecnico(int cpf, String nome, String endereco, String dataAdmissao, String titulacao, double salario, int siape, String departamento){
