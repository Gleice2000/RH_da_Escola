...
public class Docente extends Funcionario implements Salario{
     private int siape;
  private String areaVinculado;

  public Docente(int cpf, String nome, String endereco, String dataAdmissao, String titulacao, double salario, int siape, String areaVinculado) {
